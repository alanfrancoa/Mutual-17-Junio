...
// import RegisterCollectionModal from "../../../components/collections/RegisterCollectionModal";
// import AnnulCollectionModal from "../../../components/collections/AnnulCollectionModal";
      ...
      <div className="flex-1" style={{ marginLeft: "18rem" }}>
        ...
        <div className="flex flex-col items-center py-8">
          <div className="w-full max-w-6xl bg-white rounded-lg shadow p-8">
            ...
            {/* Tarjeta resumen de cobranzas */}
            {/* <CollectionsSummaryCard collections={collections} /> */}
            <div className="mb-6">
              {/* Aquí va la tarjeta resumen */}
            ...
            {/* <CollectionsDashboard collections={collections} /> */}
            <div className="mt-8">
