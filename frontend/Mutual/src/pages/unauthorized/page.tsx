  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 relative">
      ...
      <div className="flex flex-col items-center justify-center z-10 relative">
        ...
        />
        <h1 className="text-7xl font-extrabold text-blue-900 mb-4 text-center">ERROR 403</h1>
        <p className="text-2xl text-gray-700 mb-8 text-center font-semibold">Acceso no autorizado.</p>
        <button
